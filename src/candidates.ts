/**
 * Keyword-query candidates for a natural-language request. Jev picks one; it selects, it does not generate.
 * Candidate 0 is always the request as typed.
 * Adapted from superagents-lab/jev-search src/lib/candidates.ts (MIT, Copyright (c) 2026 Search1API).
 */
const TIME_PHRASES = [
